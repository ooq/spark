...
private[spark] class PageShuffleManager(conf: SparkConf) extends ShuffleManager {

  override val shuffleBlockResolver = new PageShuffleBlockResolver(conf)

...
private[spark] class NoCopyShuffleManager(conf: SparkConf) extends ShuffleManager {
  private[this] val numMapsForShuffle = new ConcurrentHashMap[Int, Int]()

  override val shuffleBlockResolver = new NoCopyShuffleBlockResolver(conf)
